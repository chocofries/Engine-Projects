...
void AudioManager::Initialise()
{
	...
	//BGM
	result = audioSystem->createSound("Assets/WormForLunch.mp3", FMOD_DEFAULT | FMOD_CREATESAMPLE, 0, &bgm);
	result = audioSystem->createSound("Assets/TitleMusic.wav", FMOD_DEFAULT | FMOD_CREATESAMPLE | FMOD_LOOP_NORMAL, 0, &titleMusic);
